# Intellectual Property & Open Source Philosophy
...
## Other Lifesaver Labs Projects

### Safeword™ Experiment
For the **Safeword™** project, Lifesaver Labs PBC has:
- ✅ **Issued patent(s)** protecting core innovations
- ✅ **Registered trademark** for the Safeword brand
- ✅ Additional intellectual property that is actively defended
...
- Innovation protection (where appropriate)
- Community collaboration (where beneficial)
- Open source principles (as default approach)
- Brand coherence (via trademarks)
...
4. **No vendor lock-in** - Communities can self-host if needed
