...
**Currently Eligible:**
- ✅ U.S. citizens age 18+ (in most states, additional restrictions may apply)

### Who Currently Cannot Vote (But Are U.S. Citizens)
**Disenfranchised Citizens:**
- ❌ Youth ages 13-17 (30+ million disenfranchised future voters)
- ❌ Disenfranchised felons (4+ million, varies by state)
- ❌ Some citizens with certain legal status (varies by jurisdiction)

### Who Cannot Vote (Non-Citizens)
**Not Eligible:**
- ❌ Permanent residents (green card holders)
- ❌ Visitors, tourists, temporary workers
...
Your citizenship status:
  ◉ U.S. Citizen - Age 18+ (eligible to vote)
  ○ U.S. Citizen - Age 13-17 (not yet eligible)
  ○ U.S. Citizen - Disenfranchised felon
  ○ U.S. Citizen - Other disenfranchisement
  ○ Non-citizen resident/visitor
  ○ Prefer not to say
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🗳️ SUFFRAGE ALERT: YOUR NEIGHBORHOOD 🗳️
...
Current neighborhood status:
  📊 67% registered (Target: 90%+)
  🎯 33% not registered or status unknown
...
**🗳️ REGISTRATION EMERGENCY (Orange Alert)**
...
**🗳️ CIVIC ENGAGEMENT REMINDER (Yellow Alert)**
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🗳️ ELECTION COMING: November 5

You have 30 days to make your plan to vote.

✓ You're registered at: 123 Main St
✓ Your polling place: Lincoln Elementary
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🗳️ ELECTION IN 14 DAYS

Early voting is NOW OPEN in your area!

Your early voting locations (nearest):
  📍 City Hall - 0.3 mi (Open 8am-6pm)
  📍 Community Center - 0.8 mi (Open 9am-5pm)
...
If not yet:
  ...
  • Mail ballot MUST be postmarked by: Nov 4
...
Your polling place:
  ...
  🚗 5 min drive | 🚶 12 min walk

[NAVIGATE TO POLLS NOW]

⚠️ This alert repeats every 2 hours until
...
1. **Document existence** — Make yourself counted, not invisible
2. **Protest disenfranchisement** — Demonstrate that you're aware, engaged, and silenced
3. **Create pressure for reform** — When thousands of protest ballots pile up, change becomes possible
...
Why this matters:
• You're aware and engaged
• Your silence is forced, not chosen
• If you don't show up, no one will fight
...
• You're engaged in your community
• If you don't show up, your rights won't
  be restored
...
- Protest ballots are **not illegal** — they're civic expression
...
Benefits:
  ✓ Government represents everyone, not just
    the most motivated
  ✓ Reduces influence of extreme voices
  ✓ Makes election day a celebration
  ✓ Small fine ($20) for not voting - not jail

Current Status in Your State:
  ❌ No mandatory voting laws
...
- ✅ Basic voting reminders (30, 14, 7, 3 days, election day)
- ✅ Polling place navigation
- ✅ "I Voted" confirmation button
- ✅ Simple civic engagement messaging
- ✅ Citizenship status tracking (U.S. citizen vs. non-citizen)

### Phase 2 (Post-MVP, Before November 2026)

- 🔲 **Protest ballot generation** (for disenfranchised youth 13-17 and felons)
- 🔲 **Suffrage Alerts** (community-wide civic emergencies)
- 🔲 Ballot information lookup
- 🔲 Ride coordination
- 🔲 Voter education content
- 🔲 Advocacy campaigns for mandatory voting
- 🔲 Gamification & badges
- 🔲 Community voting stats
- 🔲 Group coordination for protest ballot delivery

### Phase 3 (Post-November 2026)

- 🔲 Vote-by-mail tracking
- 🔲 Town hall coordination
- 🔲 Local ballot measure debates
- 🔲 Voter registration drives through app
- 🔲 Analysis of protest ballot impact and suffrage reform progress
