...
- **Email:** leadership@lifesaverlabs.org
...
- Comments, commits, code, issues, and other contributions that violate this Code of Conduct
- Contributors who engage in unacceptable behavior

Depending on severity, consequences may include:
1. **Warning** - Private written warning about the violation
2. **Temporary Ban** - Temporary suspension from the project and community spaces
3. **Permanent Ban** - Permanent removal from all project spaces and activities

## Scope

This Code of Conduct applies:
- Within all project spaces (GitHub, Discord, Reddit, email, etc.)
- When representing the project in public spaces
- In one-on-one communications related to project business

## Attribution

This Code of Conduct is adapted from the [Contributor Covenant](https://www.contributor-covenant.org), version 2.1, and the [Django Code of Conduct](https://www.djangoproject.com/conduct/).

## Questions?

If you have questions about this Code of Conduct, please contact team@lifesaverlabs.org.

---

**Remember:** We're building life-saving technology together. Let's create a community worthy of that mission.
